...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Mark canvas as ready immediately to show placeholder
    setCanvasReady(true);
      ...
      <section className={`relative min-h-screen bg-black flex items-center px-[6%] overflow-hidden transition-opacity duration-1500 ${
        ...
        <div className="flex flex-col lg:flex-row w-full items-center gap-8 py-24 lg:py-0">
          ...
          <div className="w-full lg:flex-1 min-w-0 z-10">
            ...
            {/* Headline */}
            <h1 className="font-black text-white/90 leading-[1.05] tracking-tight mb-4 uppercase text-[12vw] sm:text-[9vw] md:text-[7vw] lg:text-[4.5vw] xl:text-[50px]">
              Events Built<br />
              for the<br />
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center text-center border border-white/30 text-white/70 hover:text-white hover:border-white/60 text-[12px] md:text-[13px] font-bold px-6 md:px-7 py-3 md:py-3.5 rounded-md uppercase tracking-[0.06em] transition-all duration-200"
              >
                Learn More
              </Link>
            </div>
